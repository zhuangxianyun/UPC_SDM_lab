...
graph.add((LAB.hasKeywords, RDFS.range, LAB.Keywords))
...
# --------------------- 2) Keywords Super Class --------------------------- #
graph.add((LAB.Paper, RDF.type, RDFS.Class))
graph.add((LAB.Paper, RDFS.label, Literal("Keywords")))


# --------------------- 3) Person Super Class --------------------------- #
